...
public class GUID
{
	...
	private static function core_sha1(_arg_1:Array, _arg_2:Number):Array
	{
		...
		var _local_10:Array = new Array(80);
		var _local_11:Number = 1732584193;
		var _local_12:Number = -271733879;
		var _local_13:Number = -1732584194;
		var _local_14:Number = 271733878;
		var _local_15:Number = -1009589776;
		...
		while (_local_16 < _arg_1.length)
		{
			...
			while (_local_8 < 80)
			{
				if (_local_8 < 16)
				{
					_local_10[_local_8] = _arg_1[(_local_16 + _local_8)];
				}
				else
				{
