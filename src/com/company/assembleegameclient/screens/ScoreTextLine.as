...
public class ScoreTextLine extends Sprite implements TooltipAble
{
	...
	{
		var _local_2:int;
		var _local_3:Number = Math.min(1, ((getTimer() - this.startTime_) / 500));
		if (this.numberText_ != null)
		{
			_local_2 = (this.number_ * _local_3);
			this.numberText_.setStringBuilder(new StaticStringBuilder((((this.numberPrefix_ + _local_2.toString()) + " ") + this.unit_)));
