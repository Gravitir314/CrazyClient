...
public class Slot extends Sprite
{
	...
	{
		var _local_1:Point;
		var _local_2:BitmapTextFactory;
		...
		switch (this.type_)
		{
			case ALL_TYPE:
				break;
			case SWORD_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 48);
				break;
			case DAGGER_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 96);
				break;
			case BOW_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 80);
				break;
			case TOME_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 80);
				break;
			case SHIELD_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 112);
				break;
			case LEATHER_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 0);
				break;
			case PLATE_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 32);
				break;
			case WAND_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 64);
				break;
			case RING_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj", 44);
				break;
			case SPELL_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 64);
				break;
			case SEAL_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 160);
				break;
			case CLOAK_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 32);
				break;
			case ROBE_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 16);
				break;
			case QUIVER_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 48);
				break;
			case HELM_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 96);
				break;
			case STAFF_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj5", 112);
				break;
			case POISON_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 128);
				break;
			case SKULL_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 0);
				break;
			case TRAP_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 16);
				break;
			case ORB_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 144);
				break;
			case PRISM_TYPE:
				_local_3 = AssetLibrary.getImageFromSet("lofiObj6", 176);
				break;
			case SCEPTER_TYPE:
		...
		if (this.backgroundImage_ == null)
		{
			if (_local_3 != null)
			{
				_local_1 = this.offsets(-1, this.type_, true);
				this.backgroundImage_ = new Bitmap(_local_3);
				this.backgroundImage_.x = (BORDER + _local_1.x);
				this.backgroundImage_.y = (BORDER + _local_1.y);
			...
			else
			{
				if (this.hotkey_ > 0)
				{
					_local_2 = StaticInjectorContext.getInjector().getInstance(BitmapTextFactory);
					_local_3 = _local_2.make(new StaticStringBuilder(String(this.hotkey_)), 26, 0x363636, true, IDENTITY_MATRIX, false);
					this.backgroundImage_ = new Bitmap(_local_3);
