...
public class ConfirmBuyModal extends Sprite
    {
        ...
        {
            var _local_5:TextFieldConcreteBuilder;
            var _local_6:ItemWithTooltip;
            super();
            ...
            var _local_7:String = this.owner_.soldObjectName();
            _local_5 = new TextFieldConcreteBuilder();
            _local_5.containerMargin = TEXT_MARGIN;
            _local_5.containerWidth = WIDTH;
            addChild(_local_5.getLocalizedTextObject(TextKey.BUY_CONFIRMATION_TITLE, TEXT_MARGIN, 5));
            addChild(_local_5.getLocalizedTextObject(TextKey.BUY_CONFIRMATION_DESC, TEXT_MARGIN, 40));
            addChild(_local_5.getLocalizedTextObject(_local_7, TEXT_MARGIN, 90));
            var _local_8:* = _local_5.getLocalizedTextObject(TextKey.BUY_CONFIRMATION_AMOUNT, TEXT_MARGIN, 140);
            addChild(_local_8);
            this.quantityInputText = _local_5.getLiteralTextObject("1", TEXT_MARGIN, 160);
