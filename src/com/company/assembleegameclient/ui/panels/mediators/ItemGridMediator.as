...
public class ItemGridMediator extends Mediator 
    {
        ...
        private function onTileMove(_arg_1:ItemTileEvent):void
        {
            ...
            var _local_3:int;
            var _local_4:FoodFeedFuseSlot;
            var _local_5:int;
            var _local_6:XML;
            var _local_7:XML;
            var _local_8:InteractiveItemTile = _arg_1.tile;
            var _local_9:* = DisplayHierarchy.getParentWithTypeArray(_local_8.getDropTarget(), InteractiveItemTile, FoodFeedFuseSlot, Map, CooldownTimer);
            if (((_local_8.getItemId() == PotionInventoryModel.HEALTH_POTION_ID) || ((_local_8.getItemId() == PotionInventoryModel.MAGIC_POTION_ID) && (!(Boolean((_local_9 as FoodFeedFuseSlot)))))))
            {
            ...
            {
                if ((_local_9 is FoodFeedFuseSlot))
                {
                    _local_4 = (_local_9 as FoodFeedFuseSlot);
                    if (!_local_4.processing)
                    {
                        this.petSlotsState.rightSlotId = _local_8.tileId;
                        this.petSlotsState.rightSlotOwnerId = _local_8.ownerGrid.owner.objectId_;
                        _local_5 = _local_8.getItemId();
                        _local_4.setItem(_local_5, _local_8.tileId, _local_8.ownerGrid.owner.objectId_, this.petFoodCancel(_local_8));
                        _local_8.setItem(ItemConstants.NO_ITEM);
