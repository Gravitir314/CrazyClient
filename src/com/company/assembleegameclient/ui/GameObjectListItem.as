...
public class GameObjectListItem extends Sprite
{
	...
	public function GameObjectListItem(_arg_1:uint, _arg_2:Boolean, _arg_3:GameObject, _arg_4:Boolean = false, _arg_5:int = 0)
	{
	...
	private function prepareText():TemplateBuilder
	{
		...
		else
		{
			if (this.isNameDefined())
			{
				if (this.amount > 1)
				{
					this.builder.setTemplate((((this.objname + " (") + this.amount) + ")"));
				}
				else
				{
