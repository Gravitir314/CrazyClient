...
public class PlayerGameObjectListItem extends GameObjectListItem implements TooltipAble
{
	...
	public function PlayerGameObjectListItem(_arg_1:uint, _arg_2:Boolean, _arg_3:GameObject, _arg_4:Boolean = true, _arg_5:int = 0)
	{
		super(_arg_1, _arg_2, _arg_3, false, _arg_5);
		var _local_6:Player = (_arg_3 as Player);
		if (_local_6)
		{
