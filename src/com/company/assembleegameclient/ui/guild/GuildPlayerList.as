...
public class GuildPlayerList extends Sprite
    {
        ...
        private function build(_arg_1:XML):void
        {
            ...
            _local_2 = _local_9.graphics;
            _local_2.beginFill(0);
            _local_2.drawRect(0, 0, MemberListLine.WIDTH, 430);
            _local_2.endFill();
            this.mainSprite_.addChild(_local_9);
            this.mainSprite_.mask = _local_9;
            addChild(this.mainSprite_);
            this.listSprite_ = new Sprite();
            for each (_local_3 in _arg_1.Member)
            {
                _local_5 = (this.myName_ == _local_3.Name);
                _local_6 = _local_3.Rank;
                _local_7 = new MemberListLine(((this.offset_ + _local_8) + 1), _local_3.Name, _local_3.Rank, _local_3.Fame, _local_5, this.myRank_);
            ...
            this.openSlotsText_.y = (_local_8 * MemberListLine.HEIGHT);
