...
public class BoostPanel extends Sprite
    {
        ...
        private function createHeader():void
        {
            ...
            var _local_3:BitmapData = TextureRedrawer.redraw(AssetLibrary.getImageFromSet("lofiInterfaceBig", 22), 20, true, 0);
            _local_1 = new Bitmap(_local_3);
            _local_1.x = -3;
            _local_1.y = -1;
            addChild(_local_1);
            _local_2 = new TextFieldDisplayConcrete().setSize(16).setColor(0xFF00);
            _local_2.setBold(true);
            _local_2.setStringBuilder(new LineBuilder().setParams(TextKey.BOOSTPANEL_ACTIVEBOOSTS));
            _local_2.setMultiLine(true);
