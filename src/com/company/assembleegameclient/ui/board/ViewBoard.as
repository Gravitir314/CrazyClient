...
public class ViewBoard extends Sprite
{
	...
	public function ViewBoard(_arg_1:String, _arg_2:Boolean)
	{
		...
		var _local_5:Graphics = _local_4.graphics;
		_local_5.beginFill(0);
		_local_5.drawRect(0, 0, TEXT_WIDTH, TEXT_HEIGHT);
		_local_5.endFill();
		this.mainSprite_.addChild(_local_4);
		this.mainSprite_.mask = _local_4;
		addChild(this.mainSprite_);
		_local_3 = HTMLUtil.escape(_arg_1);
		_local_3 = _local_3.replace(URL_REGEX, ('<font color="#7777EE"><a href="$1" target="_blank">' + "$1</a></font>"));
		...
		this.boardText_.htmlText = _local_3;
