...
public class ObjectFace3D
    {
        ...
        public function ObjectFace3D(_arg_1:Object3D, _arg_2:Vector.<int>, _arg_3:Boolean=true)
        {
            ...
            while (_local_4 < this.indices_.length)
            {
        ...
        public function draw(_arg_1:Vector.<IGraphicsData>, _arg_2:uint, _arg_3:BitmapData):void
        {
            ...
            var _local_9:Vector.<Number> = this.obj_.vS_;
            var _local_10:Number = (_local_9[_local_7] - _local_9[_local_6]);
            var _local_11:Number = (_local_9[(_local_7 + 1)] - _local_9[(_local_6 + 1)]);
            var _local_12:Number = (_local_9[_local_8] - _local_9[_local_6]);
            var _local_13:Number = (_local_9[(_local_8 + 1)] - _local_9[(_local_6 + 1)]);
            ...
            {
                _local_4 = this.indices_[_local_5];
