...
{
	// TODO last file: UseBuyPotionCommand.as
	...
	public static function setDefaults():void
	{
		...
		setDefault("dbQuiet", true);
		setDefault("dbWeak", true);
		setDefault("dbSlowed", true);
		setDefault("dbSick", true);
		setDefault("dbDazed", true);
		setDefault("dbStunned", true);
		setDefault("dbParalyzed", true);
		setDefault("dbBleeding", true);
		setDefault("dbArmorBroken", true);
		setDefault("dbUnstable", false);
		setDefault("dbQuietCastle", true);
		setDefault("dbUnstableAbil", false);
		setDefault("dbPetStasis", true);
		setDefault("dbPetrify", true);
