...
public class CharacterStatusText extends Sprite implements IMapOverlayElement
    {
        ...
        {
            var _local_1:Bitmap;
            var _local_2:BitmapData = new BitmapData(this.textDisplay.width, this.textDisplay.height, true, 0);
            _local_1 = new Bitmap(_local_2);
            _local_2.draw(this.textDisplay, new Matrix());
            _local_1.x = (_local_1.x - (_local_1.width * 0.5));
            _local_1.y = (_local_1.y - (_local_1.height * 0.5));
            addChild(_local_1);
