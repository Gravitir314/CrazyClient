...
public class Triangle 
    {
        ...
        private static function lineRectIntersect(_arg_1:Number, _arg_2:Number, _arg_3:Number, _arg_4:Number, _arg_5:Number, _arg_6:Number, _arg_7:Number, _arg_8:Number):Boolean
        {
            ...
            var _local_13:Number = ((_arg_4 - _arg_2) / (_arg_3 - _arg_1));
            var _local_14:Number = (_arg_2 - (_local_13 * _arg_1));
            if (_local_13 > 0)
            {
                _local_9 = ((_local_13 * _arg_5) + _local_14);
                _local_10 = ((_local_13 * _arg_7) + _local_14);
            }
            else
            {
                _local_9 = ((_local_13 * _arg_7) + _local_14);
                _local_10 = ((_local_13 * _arg_5) + _local_14);
            }
            if (_arg_2 < _arg_4)
            {
                _local_11 = _arg_2;
            ...
            var _local_15:Number = ((_local_9 > _local_11) ? _local_9 : _local_11);
            var _local_16:Number = ((_local_10 < _local_12) ? _local_10 : _local_12);
