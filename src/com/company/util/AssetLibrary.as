...
public class AssetLibrary 
    {
        ...
        public static function addImageSet(_arg_1:String, _arg_2:BitmapData, _arg_3:int, _arg_4:int):void
        {
            var _local_5:int;
            images_[_arg_1] = _arg_2;
            var _local_6:ImageSet = new ImageSet();
            _local_6.addFromBitmapData(_arg_2, _arg_3, _arg_4);
            imageSets_[_arg_1] = _local_6;
            while (_local_5 < _local_6.images_.length)
            {
        ...
        public static function getSound(_arg_1:String):Sound
        {
            ...
            var _local_3:int = int(int((Math.random() * _local_2.length)));
        ...
        public static function playSound(_arg_1:String, _arg_2:Number=1):void
        {
            ...
            var _local_4:Array = sounds_[_arg_1];
            var _local_5:int = int(int((Math.random() * _local_4.length)));
            var _local_6:Sound = new (sounds_[_arg_1][_local_5])();
            if (_arg_2 != 1)
            {
