...
public class GraphicsUtil 
    {
        ...
        public static function drawCircle(_arg_1:Number, _arg_2:Number, _arg_3:Number, _arg_4:GraphicsPath, _arg_5:int=8):void
        {
            ...
            var _local_12:Number = (1 + (1 / (_arg_5 * 1.75)));
            _arg_4.moveTo((_arg_1 + _arg_3), _arg_2);
            var _local_13:int = 1;
            while (_local_13 <= _arg_5)
            {
                _local_6 = ((TWO_PI * _local_13) / _arg_5);
                _local_7 = ((TWO_PI * (_local_13 - 0.5)) / _arg_5);
                _local_8 = (_arg_1 + (_arg_3 * Math.cos(_local_6)));
                _local_9 = (_arg_2 + (_arg_3 * Math.sin(_local_6)));
                _local_10 = (_arg_1 + ((_arg_3 * _local_12) * Math.cos(_local_7)));
