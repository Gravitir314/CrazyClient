...
package com.company.util
{
    public class Trig 
    {
        ...
        public static function testFunc1(_arg_1:Function, _arg_2:Function):Boolean
        {
            ...
            var _local_4:Number;
            var _local_5:int;
            var _local_6:Random = new Random();
            while (_local_5 < 1000)
            {
                _local_3 = (((_local_6.nextInt() % 2000) - 1000) + _local_6.nextDouble());
                _local_4 = Math.abs((_arg_1(_local_3) - _arg_2(_local_3)));
                if (_local_4 > 0.1)
                {
                    return (false);
                }
        ...
        public static function testFunc2(_arg_1:Function, _arg_2:Function):Boolean
        {
            ...
            var _local_5:Number;
            var _local_6:int;
            var _local_7:Random = new Random();
            while (_local_6 < 1000)
            {
                _local_3 = (((_local_7.nextInt() % 2000) - 1000) + _local_7.nextDouble());
                _local_4 = (((_local_7.nextInt() % 2000) - 1000) + _local_7.nextDouble());
                _local_5 = Math.abs((_arg_1(_local_3, _local_4) - _arg_2(_local_3, _local_4)));
                if (_local_5 > 0.1)
                {
                    return (false);
                }
