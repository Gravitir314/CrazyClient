...
public class RectangleUtil 
    {
        ...
        public static function lineSegmentIntersectsXY(_arg_1:Rectangle, _arg_2:Number, _arg_3:Number, _arg_4:Number, _arg_5:Number):Boolean
        {
            ...
            var _local_10:Number = ((_arg_5 - _arg_3) / (_arg_4 - _arg_2));
            var _local_11:Number = (_arg_3 - (_local_10 * _arg_2));
            if (_local_10 > 0)
            {
                _local_6 = ((_local_10 * _arg_1.left) + _local_11);
                _local_7 = ((_local_10 * _arg_1.right) + _local_11);
            }
            else
            {
                _local_6 = ((_local_10 * _arg_1.right) + _local_11);
                _local_7 = ((_local_10 * _arg_1.left) + _local_11);
            }
            if (_arg_3 < _arg_5)
            {
                _local_9 = _arg_3;
            ...
            var _local_12:Number = ((_local_6 > _local_9) ? _local_6 : _local_9);
            var _local_13:Number = ((_local_7 < _local_8) ? _local_7 : _local_8);
        ...
        public static function getRotatedRectExtents2D(_arg_1:Number, _arg_2:Number, _arg_3:Number, _arg_4:Number, _arg_5:Number):Extents2D
        {
            ...
            _local_9.translate((-(_arg_4) / 2), (-(_arg_5) / 2));
            _local_9.rotate(_arg_3);
            _local_9.translate(_arg_1, _arg_2);
            var _local_10:Extents2D = new Extents2D();
            ...
            while (_local_8 <= 1)
            {
                ...
                while (_local_7 <= 1)
                {
                    _local_11.x = (_local_8 * _arg_4);
                    _local_11.y = (_local_7 * _arg_5);
                    _local_6 = _local_9.transformPoint(_local_11);
                    _local_10.add(_local_6.x, _local_6.y);
                    _local_7++;
                }
                _local_8++;
            }
