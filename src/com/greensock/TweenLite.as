...
public class TweenLite extends Animation
{
	...
	{
		var immediate:Boolean = vars.immediateRender, i:int, initPlugins:Boolean, pt:PropTween, p:String, copy:Object;
		if (vars.startAt)
		{
			if (_startAt != null)
			{
		...
		if (_overwrittenProps) if (_firstPT == null) if (typeof(target) !== "function")
	...
	protected function _initProps(target:Object, propLookup:Object, siblings:Array, overwrittenProps:Object):Boolean
	{
		...
		if (overwrittenProps) if (_kill(overwrittenProps, target))
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------
	...
	public static function killTweensOf(target:*, onlyActive:* = false, vars:Object = null):void
	{
		...
		var a:Array = TweenLite.getTweensOf(target, onlyActive), i:int = a.length;
		while (--i > -1)
		{
