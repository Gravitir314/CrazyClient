...
public class SliceScalingButton extends BaseButton
    {
        ...
        override public function set disabled(_arg_1:Boolean):void
        {
            ...
            if (this._interactionEffects)
            {
                if (_arg_1)
                {
                    GreyScale.setGrayScale(this.bitmap.bitmapData);
                }
                else
                {
        ...
        public function render():void
        {
            ...
            this._label.x = (((this._bitmapWidth - this._label.textWidth) / 2) + this.bitmap.marginX);
            this._label.y = (((this.bitmap.height - this._label.textHeight) / 2) + this.bitmap.marginY);
        }
