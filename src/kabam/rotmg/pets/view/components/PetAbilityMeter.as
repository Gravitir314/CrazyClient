...
public class PetAbilityMeter extends Sprite implements TooltipAble
    {
        ...
        private function onChainedFill():void
        {
            ...
            _local_1 = PetsAbilityLevelHelper.getAbilityPointsforLevel(this.levelShown);
            if (this.pointsLeftToAdd > _local_1)
            {
                this.abilityBar.reset();
                this.pointsLeftToAdd = (this.pointsLeftToAdd - _local_1);
                this.abilityBar.fill();
            }
            else
            {
