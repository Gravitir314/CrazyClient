...
public class PetVO
    {
        ...
        public function extractAbilityData(_arg_1:XML):void
        {
            ...
            var _local_4:int;
            var _local_5:uint = this.abilityList.length;
            _local_2 = 0;
            while (_local_2 < _local_5)
            {
                _local_3 = this.abilityList[_local_2];
                _local_4 = int(_arg_1.Abilities.Ability[_local_2].@type);
                _local_3.name = getPetDataDisplayId(_local_4);
                _local_3.description = getPetDataDescription(_local_4);
        ...
        public function getSkin(_arg_1:Number=1):Bitmap
        {
            this.makeSkin();
            var _local_2:MaskedImage = this.skin.imageFromAngle(0, AnimatedChar.STAND, 0);
            var _local_3:int = (((this.rarity == PetRarityEnum.DIVINE.value) ? 40 : 80) * _arg_1);
            var _local_4:BitmapData = TextureRedrawer.resize(_local_2.image_, _local_2.mask_, _local_3, true, 0, 0);
