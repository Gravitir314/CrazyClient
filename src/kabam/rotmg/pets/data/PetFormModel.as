...
public class PetFormModel 
    {
        ...
        public function createPetFamilyTree():void
        {
            ...
            {
                _local_2 = this.petsXML.Object[_local_1];
        ...
        private function fetchSkinTypeByID(_arg_1:String):int
        {
            ...
            var _local_3:XML;
            var _local_4:String;
            var _local_5:uint = this.petsXML.Object.length();
            _local_2 = 0;
            while (_local_2 < _local_5)
            {
                _local_3 = this.petsXML.Object[_local_2];
                _local_4 = _local_3.@id;
                if (this.petNodeIsSkin(_local_3))
                {
                    if (_local_4 == _arg_1)
                    {
