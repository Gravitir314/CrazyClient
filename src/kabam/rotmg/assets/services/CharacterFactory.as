...
public class CharacterFactory
    {
        ...
        public function makeIcon(_arg_1:CharacterTemplate, _arg_2:int=100, _arg_3:int=0, _arg_4:int=0, _arg_5:Boolean=false):BitmapData
        {
            ...
            _local_7 = GlowRedrawer.outlineGlow(_local_7, ((_arg_5) ? uint(0xFF0000) : uint(0)));
            return (BitmapUtil.cropToBitmapData(_local_7, 6, 6, (_local_7.width - 12), (_local_7.height - 6)));
        }
