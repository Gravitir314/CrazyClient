...
package kabam.rotmg.assets
{
    public class EmbeddedData 
    {
        ...
        public static function appendXML(_arg_1:Array, _arg_2:String, _arg_3:String):XML
        {
            ...
            var _local_5:XML;
            var _local_7:int;
            var _local_6:XML = new XML((((("<" + _arg_2) + "></") + _arg_2) + ">"));
            while (_local_7 < _arg_1.length)
            {
                _local_4 = XML(_arg_1[_local_7]);
                for each (_local_5 in _local_4[_arg_3])
                {
                    _local_6 = _local_6.appendChild(_local_5);
                };
                _local_7++;
            };
            return (_local_6);
