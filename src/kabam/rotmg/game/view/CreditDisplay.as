...
public class CreditDisplay extends Sprite
    {
        ...
        public function CreditDisplay(_arg_1:GameSprite=null, _arg_2:Boolean=true, _arg_3:Boolean=false, _arg_4:Number=0)
        {
            ...
            var _local_6:BitmapData = AssetLibrary.getImageFromSet(IMAGE_NAME, IMAGE_ID);
            _local_6 = TextureRedrawer.redraw(_local_6, 40, true, 0);
            this.coinIcon_ = new Bitmap(_local_6);
            ...
            {
                _local_5 = StaticInjectorContext.getInjector().getInstance(FortuneModel).getFortune();
                if (_local_5._endTime != null)
                {
                    this.fortuneTimeEnd = _local_5._endTime.time;
