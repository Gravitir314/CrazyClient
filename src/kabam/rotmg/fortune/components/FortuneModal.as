...
public class FortuneModal extends EmptyFrame
    {
        ...
        private function onItemSwitch(_arg_1:TimerEvent=null):void
        {
            ...
            _local_4.setXPos(this.crystalMain.getCenterX());
            _local_4.setYPos(this.crystalMain.getCenterY());
            this.tooltipItems[_local_3] = _local_4;
            _local_4.alpha = 0;
            addChild(_local_4);
            this.doEaseInAnimation(_local_4, {"alpha":1});
            this.currenttooltipItem = _local_3;
            var _local_5:Player = StaticInjectorContext.getInjector().getInstance(GameModel).player;
        ...
        {
            var _local_1:int;
            var _local_2:CrystalSmall;
            do 
            {
                _local_1 = int(int(int((Math.random() * 3))));
        ...
        private function onFirstBuySub(_arg_1:int):void
        {
            ...
            if (_local_3 != null)
            {
                if ((((_arg_1 == Currency.GOLD) && (this.state == STATE_ROUND_2)) && ((_local_3.credits_ - this.goldPriceSecond_) < 0)))
                {
            ...
            if (((this.state == STATE_ROUND_1) && (!(this.client.requestInProgress()))))
            {
                ...
                if (_local_3 != null)
                {
                    ...
                    {
                        _local_3.credits_ = (_local_3.credits_ - this.goldPrice_);
                        this.creditDisplay_.draw(_local_3.credits_, 0, _local_3.tokens_);
                    }
                    else
                    {
            ...
            else
            {
                if (this.state == STATE_ROUND_2)
                {
                    ...
                    _local_3 = StaticInjectorContext.getInjector().getInstance(GameModel).player;
                    if (_local_3 != null)
                    {
        ...
        private function resetBalls():void
        {
            var _local_1:Number;
            var _local_2:int;
            var _local_3:int = INIT_RADIUS_FROM_MAINCRYTAL;
            while (_local_2 < 3)
            {
                _local_1 = (((((_local_2 + 1) * 120) - 60) * Math.PI) / 180);
                this.crystals[_local_2].setXPos((this.crystalMain.getCenterX() + (_local_3 * Math.sin(_local_1))));
                this.crystals[_local_2].setYPos((this.crystalMain.getCenterY() + (_local_3 * Math.cos(_local_1))));
        ...
        private function resetBallsRound2():void
        {
            ...
            var _local_2:int;
            var _local_3:int;
            var _local_4:int = INIT_RADIUS_FROM_MAINCRYTAL;
            ...
            while (_local_3 < 3)
            {
                if (this.crystals[_local_3] != this.crystalClicked)
                {
                    _local_1 = ((((_local_2 * 120) - 60) * Math.PI) / 180);
        ...
        public function spinCrystals():void
        {
            var _local_1:Number;
            var _local_2:int;
            var _local_3:int = int(((200 * Math.abs(((int((getTimer() / 2)) % 1000) - 500))) / 1000));
        ...
        public function onEnterFrame(_arg_1:Event):void
        {
            ...
            var _local_5:int = (_local_4 - this.lastUpdate_);
            fMouseX = mouseX;
            fMouseY = mouseY;
