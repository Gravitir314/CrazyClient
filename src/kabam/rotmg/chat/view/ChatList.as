...
public class ChatList extends Sprite
{
	...
	public function showAvailable():void
	{
		...
		var _local_2:int = ((this.index - this.visibleItems.length) - 1);
		var _local_3:int = Math.max(0, ((this.index - this.visibleItemCount) - 1));
		var _local_4:int = _local_2;
		while (_local_4 > _local_3)
		{
			_local_1 = this.listItems[_local_4];
	...
	private function positionItems():void
	{
		var _local_1:ChatListItem;
		var _local_2:int;
		var _local_3:int = this.visibleItems.length;
		while (_local_3--)
		{
