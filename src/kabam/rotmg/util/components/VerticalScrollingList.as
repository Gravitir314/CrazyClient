...
public class VerticalScrollingList extends Sprite implements List
    {
        ...
        private function refreshScrollbar():void
        {
            ...
            var _local_3:Size = this.list.getSize();
            var _local_4:int = _local_3.height;
            _local_1 = this.list.getSizeOfItems().height;
            var _local_5:* = (_local_1 > _local_4);
            _local_2 = (!(this.scrollbar.visible == _local_5));
            this.scrollbar.setIsEnabled(false);
            this.scrollbar.visible = _local_5;
            ((_local_5) && (this.scrollbar.setIsEnabled(true)));
            ((_local_5) && (this.updateScrollbarSize(_local_4, _local_1)));
            ((_local_2) && (this.updateUiAndDispatchStateChange(_local_5)));
        }
