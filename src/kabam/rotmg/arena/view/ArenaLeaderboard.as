...
public class ArenaLeaderboard extends Sprite 
    {
        ...
        private function makeTabs():Vector.<ArenaLeaderboardTab>
        {
            ...
            var _local_4:Vector.<ArenaLeaderboardTab> = new Vector.<ArenaLeaderboardTab>();
            for each (_local_1 in ArenaLeaderboardModel.FILTERS)
            {
                _local_2 = new ArenaLeaderboardTab(_local_1);
                _local_2.y = 70;
                _local_2.selected.add(this.onSelected);
