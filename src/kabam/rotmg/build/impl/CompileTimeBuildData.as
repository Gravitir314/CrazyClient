...
public class CompileTimeBuildData implements BuildData 
    {
        ...
        {
            var _local_2:LocalConnection;
            var _local_3:Boolean = this.conditionsRequireTesting(_arg_1);
            if (_local_3)
            {
                _local_2 = new LocalConnection();
                if (((_local_2.domain == ROTMG_TESTING) || (_local_2.domain == ROTMG_TESTING_MAP)))
                {
