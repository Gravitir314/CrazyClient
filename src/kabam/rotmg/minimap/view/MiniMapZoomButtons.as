...
public class MiniMapZoomButtons extends Sprite
    {
        ...
        {
            var _local_1:Bitmap;
            var _local_2:BitmapData = AssetLibrary.getImageFromSet("lofiInterface", 54);
            ...
            this.zoomOut.x = 0;
            this.zoomOut.y = 4;
            this.zoomOut.addChild(_local_1);
        ...
        {
            var _local_1:Bitmap;
            var _local_2:BitmapData = AssetLibrary.getImageFromSet("lofiInterface", 55);
            _local_1 = new Bitmap(_local_2);
            _local_1.scaleX = 2;
            _local_1.scaleY = 2;
